//4. Создать два потока от разных классов. Один в методе run() выводит четные
//числа, другой - нечетные.
...
public class ThreadNatasha1 {
    ...
    public static class Products extends Thread {
        ...
        public String toString() {
            return "Products{" +"names=" + Arrays.toString(names) +'}';
